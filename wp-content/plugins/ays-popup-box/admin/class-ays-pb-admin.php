    ...
    public function add_action_links( $links ) {
        ...
        */
        $settings_link = array(
            ...
            '<a href="https://ays-pro.com/wordpress/popup-box?utm_source=dashboard&utm_medium=popup-free&utm_campaign=plugins-buy-now-button" target="_blank" style="color:red; font-weight: bold;">' . __('Buy Now', "ays-popup-box") . '</a>',
        );
