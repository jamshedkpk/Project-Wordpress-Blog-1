...
class Ays_Pb_Public {
	...
	public function ays_generate_popup( $attr ){
        ...
        if(isset($popupbox['onoffswitch']) && $popupbox['onoffswitch'] == 'On'){
            ...
            $ays_pb_position_mobile = isset($options['pb_position_mobile']) && $options['pb_position_mobile'] != '' ? $options['pb_position_mobile'] : 'center-center';
            ...
            $close_popup_overlay_mobile = (isset($options['close_popup_overlay_mobile']) && $options['close_popup_overlay_mobile'] == 'on') ? $options['close_popup_overlay_mobile'] : 'off';
