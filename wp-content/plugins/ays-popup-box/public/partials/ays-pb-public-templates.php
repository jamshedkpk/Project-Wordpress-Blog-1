...
class Ays_Pb_Public_Templates {
    ...
    public function ays_pb_template_template($attr){
        ...
        $ubuntu_view = "   <div class='ays_template_window ".$ays_pb_disable_scroll_on_popup_class." ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open."' {$ays_pb_flag} style='width: {$pb_width};  height: {$pb_height}; color: ".$popup['ays_pb_textcolor']." !important; font-family:{$ays_pb_font_family}; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor'].";{$bg_gradient_container}; border-radius: ".$popup['ays_pb_border_radius']."px; {$box_shadow};'>
