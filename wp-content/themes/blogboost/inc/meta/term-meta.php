<?php
if( !function_exists('blogboost_custom_taxonomy_field') ):

	// Add term page
    function blogboost_custom_taxonomy_field(){
        ...
        <div class="form-field">
            ...
            <label><?php esc_html_e('Feature Image', 'blogboost'); ?></label>
...
add_action('category_add_form_fields', 'blogboost_custom_taxonomy_field', 10, 2);


if( !function_exists('blogboost_taxonomy_edit_meta_field') ):

	// Edit term page
    function blogboost_taxonomy_edit_meta_field($term){

        $twp_term_image = get_term_meta( $term->term_id, 'twp-term-featured-image', true ); ?>
        <tr>
            
            <th scope="row" valign="top"><label><?php esc_html_e('Feature Image', 'blogboost'); ?></label></th>
...
add_action('category_edit_form_fields', 'blogboost_taxonomy_edit_meta_field', 10, 2);
