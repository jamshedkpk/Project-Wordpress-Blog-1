...
class Blogboost_Tab_Posts extends Blogboost_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'widget_blogboost_tab_posts';
        $this->widget_description = __("Displays Tab Widget", 'blogboost');
        $this->widget_id = 'blogboost_tab_posts';
        $this->widget_name = __('Blogboost: Tab Posts', 'blogboost');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'blogboost'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'blogboost'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'std' => 5,
                'min' => 1,
            ...
            'recent_heading' => array(
                'label' => esc_html__('Recent', 'blogboost'),
                'type' => 'heading',
            ),
            'recent_number' => array(
                'label' => esc_html__('No. of Posts:', 'blogboost'),
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'blogboost'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'blogboost'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'std' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'blogboost'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'blogboost'),
                'type' => 'select',
                'std' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'blogboost'),
                    'medium' => esc_html__('Medium', 'blogboost'),
                    'large' => esc_html__('Large', 'blogboost'),
                    'full' => esc_html__('Full', 'blogboost'),
                ),
            ),
            'style' => array(
                'type' => 'select',
                ...
                <ul class="tab-header-list" role="tablist">
                    <li role="presentation" tab-data="tab-popular" class="widget-tab-presentation tab-popular active">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-popular-tabpanel" role="tab">
                            <span class="screen-reader-text"><?php _e('Popular', 'blogboost'); ?></span>
                            <span class="fire-icon tab-icon">
                                <?php blogboost_theme_svg('blaze'); ?>
                            </span>
                        </a>
                    </li>
                    <li role="presentation" tab-data="tab-recent" class="widget-tab-presentation tab-recent">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-recent-tabpanel" role="tab">
                            <span class="screen-reader-text"><?php _e('Recent', 'blogboost'); ?></span>
                            <span class="flash-icon tab-icon">
                                <?php blogboost_theme_svg('star'); ?>
                            </span>
                        </a>
                    </li>
                    <li role="presentation" tab-data="tab-comments" class="widget-tab-presentation tab-comments">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-comments-tabpanel" role="tab">
                            <span class="screen-reader-text"><?php _e('Comment', 'blogboost'); ?></span>
                    ...
                    <li role="presentation" tab-data="tab-tagged" class="widget-tab-presentation tab-tagged">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-tagged-tabpanel" role="tab">
                            <span class="screen-reader-text"><?php _e('Tagged', 'blogboost'); ?></span>
                            <span class="comment-icon tab-icon">
                                <?php blogboost_theme_svg('tag'); ?>
                            </span>
                        </a>
                    </li>
                </ul>
