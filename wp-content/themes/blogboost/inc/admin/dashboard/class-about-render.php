 ...
 */
class Blogboost_Theme_Dashboard
{
    ...
    public $settings = array(
        'tabs' => array(),
        'demo_link' => 'https://preview.themeinwp.net/blogboost/',
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_blogboost_dismissed_handler', array($this, 'dismissed_handler'));
        ...
        if( isset( $_GET['page'] ) && $_GET['page'] == 'theme-dashboard' ){
            ...
            add_action('in_admin_header', array( $this,'blogboost_hide_all_admin_notice' ),1000 );

        }
    }


    public function blogboost_hide_all_admin_notice(){
    ...
    {
        add_submenu_page('themes.php', esc_html__('Blogboost Dashboard', 'blogboost'), esc_html__('Theme Dashboard', 'blogboost'), 'manage_options', $this->menu_slug, array($this, 'html_carcase'), 1);
    }
    ...
    {
        wp_enqueue_script('blogboost', get_template_directory_uri() . '/inc/admin/dashboard/js/scripts.js', array('jquery'), filemtime(get_template_directory() . '/inc/admin/dashboard/js/scripts.js'), true);

        wp_localize_script('blogboost', 'blogboost_localize', array(
            'ajax_url' => admin_url('admin-ajax.php'),
            'nonce' => wp_create_nonce('nonce'),
            'upload_image'   =>  esc_html__('Choose Image','blogboost'),
            'use_image'   =>  esc_html__('Select','blogboost'),
            'active' => esc_html__('Active','blogboost'),
            'deactivate' => esc_html__('Deactivate','blogboost'),
            'failed_message' => esc_html__('Something went wrong, contact support.', 'blogboost'),
        ));

        // Styles.
        wp_enqueue_style('blogboost', get_template_directory_uri() . '/inc/admin/dashboard/css/style.css', array(), filemtime(get_template_directory() . '/inc/admin/dashboard/css/style.css'));

        // Add RTL support.
        wp_style_add_data('blogboost', 'rtl', 'replace');
    }
                    ...
                    <div class="dashboard-feature-row dashboard-feature-row-bottom">
                        ...
                        if (isset($feature['activate_uri']) && $feature['activate_uri']) {
                            ...
                            <a href="<?php echo esc_attr($customize_uri); ?>" class="dashboard-feature-item-customize"
                               target="_blank">
                                <?php esc_html_e('Customize', 'blogboost'); ?>
                            </a>
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="suggested-enhancement">
                ...
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Fastest WordPress Hosts', 'blogboost'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('A slow host can really put a drag on your site’s performance, even an optimized one. Make sure you get a host that won’t hold you back by reading our review, complete with real speed tests, of the fastest WordPress hosts. ', 'blogboost'); ?>
                        </div>

                        <a class="suggested-enhancement-link" href="<?php echo esc_url($this->settings['insights_link_1']); ?>" target="_blank">
                            <?php esc_html_e('Read more', 'blogboost'); ?>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('WP Rocket Review', 'blogboost'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('Every site that is serious about speed (and should be pretty much all sites these days) needs a caching plugin and WP Rocket is our pick of the bunch. Get the lowdown on why we recommend it n our data-backed review: ', 'blogboost'); ?>
                        </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Best WordPress Speed Optimization Plugins', 'blogboost'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('We run through the top 10 WordPress performance plugins to keep your site running fast. Goes beyond just caching plugins (though those are on there too!). A must-read for all WordPress site owners.', 'blogboost'); ?>
                        </div>
        ...
        <div class="dashboard-hero-panel">
            <div class="hero-panel-content">
                <div class="hero-panel-subtitle">
                    <?php esc_html_e('Hello, ', 'blogboost'); ?>
                ...
                <div class="theme-admin-button-wrap theme-admin-button-group">
                    ...
                    <?php if ('themes.php' === $pagenow && 'themes' === $screen->base) { ?>
                        <a href="<?php echo esc_url(add_query_arg('page', $this->menu_slug, admin_url('themes.php'))); ?>" class="button theme-admin-button admin-button-primary">
                            ...
                            <span><?php esc_html_e('Theme Dashboard', 'blogboost'); ?></span>
                        </a>
                    <?php } ?>
                    ...
                    <a href="<?php echo esc_url($this->settings['demo_link']); ?>" class="button theme-admin-button admin-button-secondary" target="_blank">
                        ...
                        <span><?php esc_html_e('View Live Demo', 'blogboost'); ?></span>
                    </a>
                    ...
                    <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-admin-button admin-button-secondary" target="_blank">
                        ...
                        <span><?php esc_html_e('Theme Documentation', 'blogboost'); ?></span>
                    </a>
                </div>
                    ...
                    <div class="dashboard-header-panel">
                        <div class="dashboard-masthead-item dashboard-masthead-left">
                            <a href="<?php echo esc_url('https://themeinwp.com/'); ?>" class="theme-author-logo" target="_blank">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/dashboard/images/blogboost-logo.png'); ?>" alt="<?php esc_attr_e('ThemeinWP', 'blogboost'); ?>">
                            </a>
                        </div>
                        ...
                        <div class="dashboard-masthead-item dashboard-masthead-right">
                            <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-button-small theme-admin-button admin-button-secondary" target="_blank">
                                <span><?php esc_html_e('Documentation', 'blogboost'); ?></span>
                        ...
                        <div class="dashboard-hero-main-sidebar">
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-review">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title"><?php esc_html_e('Review', 'blogboost'); ?></h3>
                                </div>
                                <div class="dashboard-panel-content">
                                    ...
                                    <div class="theme-admin-description"><?php esc_html_e('It makes us happy to hear from our users. We would appreciate a review.', 'blogboost'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['review_link']); ?>"
                                           class="theme-admin-button button" target="_blank">
                                            <?php esc_html_e('Submit a Review', 'blogboost'); ?>
                                        </a>
                                    </div>

                                    <div class="theme-admin-separator"></div>

                                    <div class="theme-admin-title"><?php esc_html_e('Have an idea or feedback?', 'blogboost'); ?></div>

                                    <div class="theme-admin-description">
                                        <?php esc_html_e('If you have any suggestions or comments about our WordPress theme, please let us know. We value your feedback and strive to continuously improve our product.', 'blogboost'); ?>
                                    </div>

                                    <a href="<?php echo esc_url($this->settings['suggest_idea_link']); ?>" class="theme-feature-request" target="_blank">
                                        <?php esc_html_e('Suggest an Idea', 'blogboost'); ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-changelog">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title">
                                        <?php esc_html_e('Changelog', 'blogboost'); ?>
                                    </h3>
                                ...
                                <div class="dashboard-panel-content">
                                    <div class="theme-admin-description"><?php esc_html_e('The theme changelog provides a brief history of updates and modifications made to the theme. Keep informed with the changes and improvements that have been made over time.', 'blogboost'); ?></div>

                                    <a href="<?php echo esc_url($this->settings['changelog_link']); ?>"
                                       class="theme-changelog-info" target="_blank">
                                        <?php esc_html_e('See the Changelog', 'blogboost'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="dashboard-wrapper">
                    <div class="dashboard-footer-panel">
                        <div class="theme-dashboard-panel dashboard-panel-support">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Support', 'blogboost'); ?></h3>

                                <?php if ($this->pro_status) { ?>
                                    <div class="theme-dashboard-badge theme-badge-primary"><?php esc_html_e('Priority Status', 'blogboost'); ?></div>
                                <?php } ?>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-dashboard-subpanel">
                                    <div class="theme-admin-title">
                                        <?php echo wp_kses_post(__('Need help? We\'re here for you!', 'blogboost')); ?>
                                    </div>

                                    <div class="theme-admin-description"><?php esc_html_e('Do you have a question or have you encountered a bug? You can receive assistance from our amicable support team whenever you require it.', 'blogboost'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['support_link']); ?>"
                                           class="button theme-admin-button admin-button-secondary" target="_blank">
                                            <?php esc_html_e('Get Support', 'blogboost'); ?>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <?php if (!$this->pro_status) { ?>
                                    <div class="theme-dashboard-subpanel dashboard-subpanel-bg">
                                        <div class="theme-admin-title">
                                            <?php echo wp_kses_post(__('Upgrade to priority support', 'blogboost')); ?>

                                            <div class="theme-dashboard-badge theme-badge-secondary"><?php esc_html_e('pro', 'blogboost'); ?></div>
                                        </div>

                                        <div class="theme-admin-description">
                                            <?php esc_html_e('Receive support via email with a prompt initial response time of 1-2 hours for all priority requests.', 'blogboost'); ?>
                                        </div>

                                        <div class="theme-admin-button-wrap">
                                            <a href="<?php echo esc_url($this->settings['support_pro_link']); ?>"
                                               class="button theme-admin-button admin-button-primary" target="_blank">
                                                <?php esc_html_e('Get Priority Support', 'blogboost'); ?>
                                            </a>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="theme-dashboard-panel dashboard-panel-community">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Community', 'blogboost'); ?></h3>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-admin-title">
                                    <?php echo wp_kses_post(__('Join Our Community', 'blogboost')); ?>
                                </div>

                                <div class="theme-admin-description"><?php esc_html_e('Engage with the community: talk about products, ask for help or offer assistance to the community.', 'blogboost'); ?></div>

                                <div class="theme-admin-button-wrap">
                                    <a href="<?php echo esc_url($this->settings['community_link']); ?>"
                                       class="button theme-admin-button admin-button-tertairy" target="_blank">
                                        <?php esc_html_e('Join Now', 'blogboost'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    public function notice()
    {
        ...
        if ('themes.php' === $pagenow) {
            ...
            if (!get_transient($transient_name)) {
                ...
                ?>
                <div class="notice notice-success blogboost-primary-notice theme-admin-dashboard theme-admin-dashboard-notice is-dismissible" data-notice="<?php echo esc_attr($transient_name); ?>">
    ...
    public function notice_enqueue_scripts($page)
    {
        ...
        <script>
            jQuery(function ($) {
                $(document).on('click', '.blogboost-primary-notice .notice-dismiss', function () {
                    jQuery.post('ajax_url', {
                        action: 'blogboost_dismissed_handler',
                        notice: $(this).closest('.blogboost-primary-notice').data('notice'),
                    });
