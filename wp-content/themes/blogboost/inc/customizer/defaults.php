 ...
 * @package Blogboost
 */
if ( ! function_exists( 'blogboost_get_default_customizer_values' ) ) :
	/**
	 ...
	 */
	function blogboost_get_default_customizer_values() {
        ...
        $defaults['about_post_title'] = esc_html__('Behind the Blog', 'blogboost');
        $defaults['upload_about_image'] = '';

        // header full page add
        $defaults['ed_header_ad'] = false;
        $defaults['ed_header_type'] = 'welcome-banner-default';
        $defaults['advertisement_section_title'] = esc_html__('Welcome Advertisement Message', 'blogboost');
        ...
        $defaults['shop_post_title'] = __('Shop Now', 'blogboost');
        ...
        $defaults['shop_post_button_text'] = __('Shop Now', 'blogboost');
        ...
        $defaults['category_post_title'] = __('Welcome to BlogBoost', 'blogboost');
        ...
        $defaults['excerpt_read_more'] = __('[Read More...]', 'blogboost');
        ...
        $defaults['related_posts_text'] = __('You May Also Like', 'blogboost');
        ...
        $defaults['author_posts_text'] = __('More From Author', 'blogboost');
        ...
        $defaults['footer_recommended_post_title'] = esc_html__( 'You May Also Like:', 'blogboost' );
        ...
        $defaults['enable_footer_logo'] = true;
        $defaults['enable_footer_site_title'] = true;
        $defaults['enable_footer_site_tagline'] = true;
        $defaults['whats_app_number'] = '';
        $defaults['telephone_number'] = '';
        ...
        $defaults['copyright_text'] = esc_html__( 'Copyright &copy;', 'blogboost' );
		...
		$defaults = apply_filters( 'blogboost_default_customizer_values', $defaults );
		return $defaults;
	}
endif;