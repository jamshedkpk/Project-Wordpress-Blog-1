...
$author_posts_text = blogboost_get_option('author_posts_text');
$no_of_author_posts = absint(blogboost_get_option('no_of_author_posts'));
$order = esc_attr(blogboost_get_option('author_posts_order'));
$orderby = esc_attr(blogboost_get_option('author_posts_orderby'));
