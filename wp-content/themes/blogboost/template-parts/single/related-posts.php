...
$related_posts_text = blogboost_get_option('related_posts_text');
$no_of_related_posts = absint(blogboost_get_option('no_of_related_posts'));
$order = esc_attr(blogboost_get_option('related_posts_order'));
$orderby = esc_attr(blogboost_get_option('related_posts_orderby'));
