 ...
 * @package Blogboost
 */
$enable_about_section = blogboost_get_option('enable_about_section');
$about_post_title = blogboost_get_option('about_post_title');
$select_about_page = get_theme_mod('select_about_page');
$upload_about_image = blogboost_get_option('upload_about_image');
$facebook_url = blogboost_get_option('facebook_url');
$twiter_url = blogboost_get_option('twiter_url');
$instagram_url = blogboost_get_option('instagram_url');
                                ...
                                <?php if (!empty($facebook_url)) { ?>
                                    <li>
                                        <a href="<?php echo esc_html($facebook_url); ?>" target="_blank">
                                            <?php blogboost_theme_svg('facebook'); ?>
                                        </a>
                                    </li>
                                <?php } ?>
                                <?php if (!empty($twiter_url)) { ?>
                                    <li>
                                        <a href="<?php echo esc_html($twiter_url); ?>" target="_blank">
                                            <?php blogboost_theme_svg('twitter'); ?>
                                        </a>
                                    </li>
                                <?php } ?>
                                <?php if (!empty($instagram_url)) { ?>
                                    <li>
                                        <a href="<?php echo esc_html($instagram_url); ?>" target="_blank">
                                            <?php blogboost_theme_svg('instagram'); ?>
                                        </a>
                                    </li>
                                <?php } ?>
                            </ul>
