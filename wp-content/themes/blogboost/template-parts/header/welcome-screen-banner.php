 ...
 * @package Blogboost
 */
$ed_header_type = blogboost_get_option( 'ed_header_type' );
$upload_add_image = blogboost_get_option( 'upload_add_image' );
$ed_header_link = blogboost_get_option( 'ed_header_link' );
$advertisement_section_title = blogboost_get_option( 'advertisement_section_title' );
?>
            ...
            <header class="welcome-screen-header">
                ...
                <div class="welcome-screen-actions">
                    ...
                    <button type="button" class="welcome-screen-skip">
                        <?php echo esc_html__('Skip This', 'blogboost') ?>
                    </button>
                </div>
            </header>
        <?php } ?>
